                    ...
                    <div className="px-5 pb-5 border-t border-gray-100 pt-4 space-y-4">
                      ...
                      {isSubmitted && (
                        <div className="space-y-3 p-4 bg-gray-50 rounded-xl">
                          <p className="text-sm font-bold text-slate-700">Technical Evaluation:</p>
                          <div>
                            <label className="text-xs font-semibold text-slate-600 mb-1 block">Approval / Evaluation Notes *</label>
                            <textarea
                              rows={2}
                              ...
                              className="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm resize-none focus:ring-2 focus:ring-blue-300 focus:outline-none"
                            />
                            <button
                          ...
                          <div className="border-t border-gray-200 pt-3">
                            <label className="text-xs font-semibold text-slate-600 mb-1 block">Request Revision Reason *</label>
                            <textarea
                              rows={2}
          ...
          <>
            {(tab === 'overview') && (
              <div className="space-y-4">
                <h2 className="text-lg font-bold text-slate-700">Projects Awaiting Technical Evaluation</h2>
                ...
                {notifications.length === 0 ? (
                  ...
                  notifications.map(n => (
                    <div
                      ...
                      className={`p-4 rounded-xl border cursor-pointer ${n.read ? 'bg-white border-gray-100' : 'bg-blue-50 border-blue-200'}`}
                    >
