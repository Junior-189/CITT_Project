      ...
      <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-2xl w-full max-w-4xl my-8">
        ...
        {loading ? (
          ...
          <div className="p-6 space-y-3">
            ...
            <div className="grid grid-cols-3 gap-3 mb-4 p-4 bg-gray-50 dark:bg-slate-900 rounded-xl">
                    ...
                    <div className="px-5 pb-5 border-t border-gray-100 pt-4 space-y-4">
                      ...
                      {isSubmitted && (
                        <div className="space-y-3 p-4 bg-gray-50 dark:bg-slate-900 rounded-xl">
                          <p className="text-sm font-bold text-slate-700 dark:text-slate-200 dark:text-slate-200">Coordinate Review:</p>
                          <div>
                          ...
                          <div className="border-t border-gray-200 dark:border-slate-700 pt-3">
                            <label className="text-xs font-semibold text-slate-600 dark:text-slate-400 mb-1 block">Revision Reason *</label>
                            <textarea
                              rows={2}
          ...
          <>
            ...
            {tab === 'projects' && (
              <div className="space-y-4">
                <h2 className="text-lg font-bold text-slate-700 dark:text-slate-200 dark:text-slate-200">All Projects ({projects.length})</h2>
                {projects.length === 0 ? (
