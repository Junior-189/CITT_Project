            ...
            {data?.team?.length > 0 && (
              <div className="p-4 bg-gray-50 rounded-xl mb-4">
                ...
                <div className="flex flex-wrap gap-2">
                  {data.team.map(m => (
                    <span key={m.id} className="text-xs bg-white border border-gray-200 rounded-full px-3 py-1 text-slate-600">
                    ...
                    <div className="px-5 pb-5 border-t border-gray-100 pt-4 space-y-4">
                      ...
                      {isSubmitted && (
                        <div className="space-y-3 p-4 bg-gray-50 rounded-xl">
                          <p className="text-sm font-bold text-slate-700">Review this submission:</p>
                          <div>
                            ...
                            <textarea
                              ...
                              className="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm resize-none focus:ring-2 focus:ring-teal-300 focus:outline-none"
                            />
                            <button
          ...
          <>
            ...
            {tab === 'overview' && (
              <div className="space-y-4">
                <h2 className="text-lg font-bold text-slate-700">Projects Requiring Review</h2>
            ...
            {tab === 'projects' && (
              <div className="space-y-4">
                <h2 className="text-lg font-bold text-slate-700">All Assigned Projects ({projects.length})</h2>
                {projects.length === 0 ? (
                  <div className="bg-white rounded-xl border border-gray-100 p-10 text-center">
                  ...
                  notifications.map(n => (
                    <div
                      ...
                      className={`p-4 rounded-xl border cursor-pointer transition-colors
                        ${n.read ? 'bg-white border-gray-100' : 'bg-teal-50 border-teal-200'}`}
                    >
