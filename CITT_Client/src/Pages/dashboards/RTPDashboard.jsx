  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen">
      ...
      <div className="max-w-6xl mx-auto">
        <h1 className="text-2xl font-bold text-slate-800 mb-6">RTP Director Dashboard</h1>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          {[
            ...
            { label: 'Pending', count: pending.length, color: 'border-yellow-400' },
        ...
        <h2 className="text-lg font-semibold text-slate-700 mb-4">All Projects</h2>
        {loading ? <div className="text-center py-12 text-gray-400">Loading…</div> : (
          <div className="space-y-3">
            {projects.length === 0 && <div className="text-center py-12 bg-white rounded-xl border text-gray-400">No projects found</div>}
            {projects.map(p => {
