    ...
    <div className="min-h-screen bg-gray-50 dark:bg-slate-900 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
          ...
          <div className="bg-white dark:bg-slate-800 rounded-lg shadow-md p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-gray-600 dark:text-slate-400 text-sm">Total Projects</p>
                <p className="text-2xl font-bold text-gray-900 dark:text-slate-100">
          ...
          <div className="bg-white dark:bg-slate-800 rounded-lg shadow-md p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-gray-600 dark:text-slate-400 text-sm">Funding Apps</p>
                <p className="text-2xl font-bold text-gray-900 dark:text-slate-100">
          ...
          <div className="bg-white dark:bg-slate-800 rounded-lg shadow-md p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-gray-600 dark:text-slate-400 text-sm">IP Records</p>
                <p className="text-2xl font-bold text-gray-900 dark:text-slate-100">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <Link
            to="/superadmin/users"
            className="bg-white dark:bg-slate-800 rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow cursor-pointer border-l-4 border-teal-700"
          >
            ...
            <p className="text-gray-600 dark:text-slate-400 text-sm">Promote/demote users and manage roles</p>
            <div className="mt-3 text-xs text-teal-700 dark:text-teal-400 font-medium">SUPERADMIN ONLY</div>
          </Link>
          ...
          >
            ...
            <p className="text-gray-600 dark:text-slate-400 text-sm">View all system activity and logs</p>
            <div className="mt-3 text-xs text-teal-700 dark:text-teal-400 font-medium">SUPERADMIN ONLY</div>
          </Link>
          ...
          >
            ...
            <p className="text-gray-600 dark:text-slate-400 text-sm">View database tables and statistics</p>
            <div className="mt-3 text-xs text-teal-700 dark:text-teal-400 font-medium">SUPERADMIN ONLY</div>
          </Link>
          ...
          >
            ...
            <p className="text-gray-600 dark:text-slate-400 text-sm">View charts and comprehensive analytics</p>
            <div className="mt-3 text-xs text-teal-700 dark:text-teal-400 font-medium">SUPERADMIN & ADMIN</div>
          </Link>

          <Link
            to="/superadmin/past-users"
            className="bg-white dark:bg-slate-800 rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow cursor-pointer border-l-4 border-red-500"
          >
            <div className="flex items-center justify-between mb-4">
            ...
            <p className="text-gray-600 dark:text-slate-400 text-sm">View and restore deleted user accounts</p>
            <div className="mt-3 text-xs text-red-600 dark:text-red-400 font-medium">SUPERADMIN & ADMIN</div>
          </Link>

          <Link
            to="/admin/dashboard"
            className="bg-white dark:bg-slate-800 rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow cursor-pointer border-l-4 border-teal-600"
          >
            <div className="flex items-center justify-between mb-4">
            ...
            <p className="text-gray-600 dark:text-slate-400 text-sm">Access admin management features</p>
            <div className="mt-3 text-xs text-teal-600 dark:text-teal-400 font-medium">ADMIN ACCESS</div>
          </Link>
        </div>

        {/* Warning Box */}
        <div className="mt-6 bg-teal-50 dark:bg-teal-500/10 border-l-4 border-teal-700 dark:border-teal-400 p-4 rounded">
          <div className="flex">
            <div className="flex-shrink-0">
              <svg className="h-5 w-5 text-teal-700 dark:text-teal-400" fill="currentColor" viewBox="0 0 20 20">
