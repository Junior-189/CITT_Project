      ...
      {assigningProject && (
        <div className="fixed inset-0 z-50 bg-black/60 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl w-full max-w-md p-6">
            <h3 className="font-bold text-lg text-slate-800 mb-4">Assign Project</h3>
            ...
            <div className="flex gap-2 mt-5">
              ...
              <button onClick={() => setAssigningProject(null)} className="flex-1 px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-lg text-sm font-semibold">Cancel</button>
            </div>
          </div>
        </div>
      )}
      ...
      <div className="max-w-6xl mx-auto px-4 md:px-8 py-6">
        ...
        {activeTab === 'overview' && dashData && (
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
              <h3 className="font-bold text-slate-800 mb-4">DII Department Functions</h3>
          ...
          <div>
            <div className="flex flex-wrap gap-3 mb-5">
              <input value={projectSearch} onChange={e => setProjectSearch(e.target.value)}
                ...
                className="flex-1 min-w-[200px] border border-gray-300 rounded-xl px-4 py-2 text-sm focus:ring-2 focus:ring-teal-400 outline-none" />
              <select value={projectStatusFilter} onChange={e => setProjectStatusFilter(e.target.value)}
                className="border border-gray-300 rounded-xl px-3 py-2 text-sm focus:ring-2 focus:ring-teal-400 outline-none">
            ...
            <div className="space-y-3">
              {filteredProjects.length === 0 && (
                <div className="text-center py-12 bg-white rounded-xl border text-gray-400">No projects found</div>
              )}
        ...
        {activeTab === 'innovators' && (
          <div>
            <div className="flex items-center justify-between mb-5">
              <h2 className="font-bold text-slate-700">Innovator Database <span className="text-gray-400 font-normal text-sm">({innovators.length})</span></h2>
            </div>
                    ...
                    <tbody className="divide-y divide-gray-100">
                      {innovators.map(u => (
                        <tr key={u.id} className="hover:bg-gray-50">
                          ...
                          <td className="px-5 py-3 font-semibold text-slate-700">{u.total_projects}</td>
                          <td className="px-5 py-3">
                            <span className="px-2 py-0.5 bg-green-100 text-green-700 rounded-full text-xs font-semibold">{u.approved_projects}</span>
                          </td>
                          <td className="px-5 py-3 text-gray-500">{u.max_milestone_reached ? `Stage ${u.max_milestone_reached}` : '—'}</td>
        ...
        {activeTab === 'trainings' && (
          <div>
            ...
            {showTrainingForm && (
              <div className="bg-white rounded-2xl border border-teal-200 p-6 mb-5">
